      ...
      <section className="md:flex md:gap-10">
        <div className="md:flex-1 flex flex-col items-center mb-6 md:mb-0">
          <div className="relative w-full md:w-[400px] h-[300px] md:h-[400px] overflow-hidden rounded-lg border border-gray-700">
            ...
            <button
              onClick={prevImage}
              className="absolute left-2 top-1/2 transform -translate-y-1/2 text-white bg-black/50 p-2 rounded hover:bg-black/70 z-10"
            ...
            <button
              onClick={nextImage}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 text-white bg-black/50 p-2 rounded hover:bg-black/70 z-10"
