            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-gray-400 mb-8 leading-relaxed">
                  <strong className="text-green-400">$85 once.</strong> No
                  monthly fees. No subscriptions. Military-grade security for
              ...
              >
                {[
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`h-8 w-8 ${benefit.color} mx-auto mb-4`}
                      />
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Choose single or double protection. Both options save you
              thousands vs monthly VPNs.
            </p>
          </motion.div>
